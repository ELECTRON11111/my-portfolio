...
export default function TopBanner() {
    ...
    return (
        <div id="TopBanner" className="fixed top-0 left-0 z-[100] bg-neutral-900 text-white grid grid-cols-2 w-full p-4 px-8 select-none sm:px-4 sm:grid-cols-4 sm:p-5 md:p-7 md:px-20">
