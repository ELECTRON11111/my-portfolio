  ...
  return (
    <main className="">       
        <div id="home" className="bg-gray-100 bg-cover sm:bg-[url('../../public/assets/img-7.png')]">
          ...
          <div id="home-content" className="flex flex-col justify-between gap-6 items-center p-10 px-0 bg-black md:gap-10 lg:py-[4.1rem] lg:flex-row lg:gap-0 md:px-16">
            <div className="text-content flex flex-col gap-4 text-white px-8 leading-6">
              ...
              <p className="font-poppins leading-[32px]">
            ...
            ease-out duration-300 md:rotate-6 md:w-[450px] md:h-[450px] lg:w-[500px] hover:rotate-[-6deg]" width={400} height={400} />
          </div>
        </div>
