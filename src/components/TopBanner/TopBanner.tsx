        ...
        <div id="TopBanner" className="fixed top-0 left-0 z-[100] bg-black text-white grid grid-cols-2 w-full p-4 px-8 select-none sm:px-4 sm:grid-cols-4 sm:p-5 md:p-7 md:px-20">
            ...
            <nav className={`${isDrawerOpen? "": "hidden"} col-span-2 justify-self-center sm:block sm:self-center`}>
                <ul className="grid grid-cols-2 gap-2 sm:flex md:gap-16">
                    ...
                    <li className="link"><Link href="/#about">Experiences</Link></li>
                    <li className="link"><Link href="/#Projects">Projects</Link></li>
                    <li className="link"><Link href="/enquiries">Contact</Link></li>
                </ul>
            </nav>

            <div id="socials" className="hidden sm:flex sm:self-center sm:justify-end sm:gap-1 md:gap-2 lg:gap-3">
                <Link className="hidden lg:inline-block" href={"https://www.instagram.com/daniel_eln_/?next=https%3A%2F%2Faccountscenter.instagram.com%2F%3F__coig_login%3D1"}>
